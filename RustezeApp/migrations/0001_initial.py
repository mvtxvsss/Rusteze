# Generated by Django 4.1.7 on 2023-06-13 20:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_genero', models.ForeignKey(db_column='idGenero', on_delete=django.db.models.deletion.CASCADE, to='RustezeApp.genero')),
            ],
            options={
                'ordering': ['rut'],
            },
